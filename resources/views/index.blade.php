        ...
        <div class="row justify-content-between">
          ...
          <div class="col-lg-7">
            <div class="hero-img-wrap">
              <img src="images/productskinmak.png" class="img-fluid" float="right"/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-7 mb-5 mb-lg-0">
            <div class="imgs-grid">
              <div class="grid grid-1"><img src="images/skincare5.png.jpg" alt="Untree.co" /></div>
              <div class="grid grid-3"><img src="images/skincare8.png.jpg" alt="Untree.co" /></div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="d-flex">
              ...
              <div class="pt-3">
                <h3>Holyshield! UV Watery Sunscreen Gel SPF 50+ PA++++</h3>
            ...
            <div class="d-flex">
              ...
              <div class="pt-3">
                ...
                <p>100% lip balm vegan berwarna dengan hasil akhir noda alami, diresapi dengan 
					Avocado Oil & Hyaluronic Acid untuk melembabkan & mengurangi garis-garis halus pada bibir.<p><a href="#">Read More</a></p>
              </div>
            </div>
          </div>
        </div>
