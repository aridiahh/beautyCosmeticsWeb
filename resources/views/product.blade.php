      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsFurni">
          <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
            ...
            <li class="active"><a class="nav-link" href="/product">Product</a></li>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4 col-lg-3 mb-5">
            <a class="product-item" href="#">
              ...
              <h3 class="product-title">SUPERSTAR Pocket Eyeshadow Palette</h3>
          ...
          <div class="col-12 col-md-4 col-lg-3 mb-5">
            <a class="product-item" href="#">
              <img src="images/makeup.png" class="img-fluid product-thumbnail" />
              <h3 class="product-title">HOOMAN UNDER CONTROL HD Blur Loose Powder</h3>
              <strong class="product-price">Rp 142.000</strong>
          ...
          <div class="col-12 col-md-4 col-lg-3 mb-5">
            <a class="product-item" href="#">
              <img src="images/product4.png" class="img-fluid product-thumbnail" />
              <h3 class="product-title">Holyshield! UV Watery Sunscreen Gel SPF 50+ PA++++</h3>
              <strong class="product-price">Rp 53.900</strong>
          ...
          <div class="col-12 col-md-4 col-lg-3 mb-5">
            <a class="product-item" href="#">
              <img src="images/product51.png" class="img-fluid product-thumbnail" />
              <h3 class="product-title">Lipvocado Vegan Lip Treatment Tint</h3>
          ...
          <div class="col-12 col-md-4 col-lg-3 mb-5">
            <a class="product-item" href="#">
              <img src="images/serum1.png" class="img-fluid product-thumbnail" width="240" height="240" />
          ...
          <div class="col-12 col-md-4 col-lg-3 mb-5">
            <a class="product-item" href="#">
              <img src="images/skincare7.png" class="img-fluid product-thumbnail" />
              <h3 class="product-title">pH Restore Hair Rinsing Vinegar</h3>
              <strong class="product-price">Rp 149.000</strong>
